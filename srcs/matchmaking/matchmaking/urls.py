...
from .views import join_queue, dev_view_get_queue, leave_queue, join_tournament, get_tournament_info, leave_tournament
...
urlpatterns = [
    ...
    path('tournament/leave/', leave_tournament),
